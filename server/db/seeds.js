...
function randomDate () {
    ...
    let monthString = ('0' + month)
    let day = Math.floor(Math.random() * 20) + 10
  
    let dateString = (year + monthString + day)
  
    let finalDate = parseInt(dateString)
    return finalDate
  }
...
configureDB()
// console.log(fake.date.between('2015-01-01', '2020-3-01').toString())
// console.log(fake.date.past())
// console.log(fake.date.past())
// console.log(fake.date.past())
